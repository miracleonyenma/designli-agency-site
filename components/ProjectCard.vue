<template>
    ...
    <div class="img-cont rounded-xl h-full max-h-40 md:max-h-72 row-start-1 md:col-start-1 md:col-end-5 overflow-hidden">
        <img :src="`http://localhost:1337${project.cover.formats.large.url}`" alt="">
    </div>
    </li>
</template>
